...
/** Generated Interface for HR_Shift_Incident
 *  @author iDempiere (generated) 
 *  @version Release 8.2
 */
@SuppressWarnings("all")
public interface I_HR_Shift_Incident 
{

    /** TableName=HR_Shift_Incident */
    public static final String Table_Name = "HR_Shift_Incident";
    ...
    /** Column name HR_Shift_Incident_UU */
    public static final String COLUMNNAME_HR_Shift_Incident_UU = "HR_Shift_Incident_UU";

	/** Set HR_Shift_Incident_UU	  */
	public void setHR_Shift_Incident_UU (String HR_Shift_Incident_UU);

	/** Get HR_Shift_Incident_UU	  */
	public String getHR_Shift_Incident_UU();
